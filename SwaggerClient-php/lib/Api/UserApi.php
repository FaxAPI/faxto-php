...
class UserApi
{
    ...
    public function balanceGetWithHttpInfo($api_key)
    {
        ...
        $request = $this->balanceGetRequest($api_key);
     ...
     */
    public function balanceGetAsync($api_key)
    {
        return $this->balanceGetAsyncWithHttpInfo($api_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function balanceGetAsyncWithHttpInfo($api_key)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2007';
        $request = $this->balanceGetRequest($api_key);
     ...
     */
    protected function balanceGetRequest($api_key)
    {
        // verify the required parameter 'api_key' is set
        if ($api_key === null || (is_array($api_key) && count($api_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $api_key when calling balanceGet'
            );
        }
